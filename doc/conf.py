...
project = "Imbalanced Calibrate"
copyright = "2026, Jules Lanari-Collard"
author = "Jules Lanari-Collard"
release = get_version('imbalanced-calibrate')
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/jules-collard/imbalanced-calibrate",
...
sphinx_gallery_conf = {
    "doc_module": "imbcalibrate",
    "backreferences_dir": os.path.join("generated"),
    "examples_dirs": "../examples",
    "gallery_dirs": "auto_examples",
    "reference_url": {"imbcalibrate": None},
}
